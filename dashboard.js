    ...
    <div class="dashboard-card">
        ...
        <form class="school-form">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    <label>School Name</label>
                    <input type="text" value="Greenfield School">
                </div>

                <div class="form-group">
                    <label>Principal / Owner</label>
                    <input type="text" value="Mr. Principal">
                </div>

                <div class="form-group">
                    <label>Phone Number</label>
                    <input type="text" value="+234 XXX XXX XXXX">
                </div>

                <div class="form-group">
                    <label>Email Address</label>
                    <input type="email" value="school@example.com">
                </div>

                <div class="form-group full-width">
                    <label>School Address</label>
                    <textarea rows="3">Ilorin, Kwara State, Nigeria</textarea>
                </div>
